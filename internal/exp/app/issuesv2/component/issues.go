...
type IssueEntry struct {
	...
	ShowPackagePath bool // TODO, THINK.
...
func (i IssueEntry) Render() []*html.Node {
	...
	}
	{
		...
		if i.ShowPackagePath {
			issueTitle = i.Issue.ImportPath + ": " + issueTitle
		}
		title := htmlg.Div(
			&html.Node{
				...
				FirstChild: htmlg.Strong(issueTitle),
			},
		)
		...
		byline.AppendChild(htmlg.Text(fmt.Sprintf(" by %s", i.Issue.Author.Login)))
